[![Build Status](https://travis-ci.org/elenakves/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.org/elenakves/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/elenakves/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/elenakves/travis-ci-tutorial-java)
...
1. [Fork](https://github.com/elenakves/travis-ci-tutorial-java/fork) this Repository
...
[Open an Issue](https://github.com/elenakves/travis-ci-tutorial-java/issues/new)!
